...
DATABASES = {
    'default': {
        ...
        'NAME': 'cloudport',   # Or path to database file if using sqlite3.
        'USER': 'cloudport',  # Not used with sqlite3.
        'PASSWORD': 'C10udP0rTz13',   # Not used with sqlite3.
...
SECRET_KEY = '@el6&2f=8jaswerwerw3_!(3pj8327ndfd5_cwrwerhhfdpvm8y2qnkpxh$z%ebskm'
...
#used by staticfiles module
#STATIC_URL = "/static/"
#STATIC_ROOT = "/home/cloudport/static/"
